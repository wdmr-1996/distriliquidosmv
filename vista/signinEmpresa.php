...
<body>
    ...
    <article class="bodySignin">
        <div class="signinContainer">
            <h2 class="h2">Registro como empresa</h2>
            <?php
            ...
            <form class="credenciales" method="post">
                <div>
                    <article class="columnaSignin">
                        <input type="text" name="rut" class="formItem" placeholder="NIT" required>
                        <input type="text" name="nit" class="formItem" placeholder="RUT" required>
                        <input type="text" name="nombreEmpresa" class="formItem" placeholder="Nombre de la empresa" required>
                    </article>
                    <article class="columnaSignin">
